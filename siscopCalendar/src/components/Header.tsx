    ...
    <header className="flex items-center justify-between px-2 w-full h-14 border-b border-gray-300">
      <div className="flex items-center">
        ...
        <div className="flex items-center ml-3">
          ...
          <h1 className="ml-2 text-lg text-gray-500 hidden md:block">Calendario de Actviidades</h1>
        </div>
      </div>
      <div className="flex items-center">
        <button
      ...
      <span className="px-3 py-1 mx-3 border border-gray-200 rounded text-sm">Holi ☺</span>
    </header>
  )
}
